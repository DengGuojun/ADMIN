...
public final class AdminServicePrxHelper extends Ice.ObjectPrxHelperBase implements AdminServicePrx
{
    ...
    public Ice.AsyncResult begin_rpc(String method, String params, Callback_AdminService_rpc __cb)
    {
        return begin_rpc(method, params, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_rpc(String method, String params, java.util.Map<String, String> __ctx, Callback_AdminService_rpc __cb)
    {
        return begin_rpc(method, params, __ctx, true, false, __cb);
    }
    ...
    {
        com.lpmas.admin.component.AdminServicePrx __proxy = (com.lpmas.admin.component.AdminServicePrx)__result.getProxy();
        String __ret = null;
        try
        {
    ...
    public static AdminServicePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), AdminServicePrx.class, AdminServicePrxHelper.class);
    }

    public static AdminServicePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), AdminServicePrx.class, AdminServicePrxHelper.class);
    }

    public static AdminServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), AdminServicePrx.class, AdminServicePrxHelper.class);
    }

    public static AdminServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), AdminServicePrx.class, AdminServicePrxHelper.class);
    }

    public static AdminServicePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, AdminServicePrx.class, AdminServicePrxHelper.class);
    }

    public static AdminServicePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, AdminServicePrx.class, AdminServicePrxHelper.class);
    }

    public static final String[] __ids =
    {
        "::Ice::Object",
        "::com::lpmas::admin::component::AdminService"
    };
    ...
    public static void __write(IceInternal.BasicStream __os, AdminServicePrx v)
    {
        __os.writeProxy(v);
    }

    public static AdminServicePrx __read(IceInternal.BasicStream __is)
    {
