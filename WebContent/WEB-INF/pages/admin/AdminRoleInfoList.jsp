...
<form name="formSearch" method="post" action="AdminRoleInfoList.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_style">
    ...
    <tr>
      ...
      <td align="center"><%if(adminHelper.hasPermission(AdminResource.ADMIN_ROLE, OperationConfig.SEARCH)){ %><a href="/admin/AdminRoleInfoManage.do?roleId=<%=bean.getRoleId() %>">修改</a><%} %></td>
    </tr>
    <%} %>
  </table>
</form>
...
<li class="page_left_btn">
  <%if(adminHelper.hasPermission(AdminResource.ADMIN_ROLE, OperationConfig.CREATE)){ %><input type="button" name="button" id="button" value="新建" onclick="javascript:location.href='AdminRoleInfoManage.do'"><%} %>
</li>
