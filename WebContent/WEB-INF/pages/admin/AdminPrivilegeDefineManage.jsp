...
<form name="formData" method="post" action="AdminPrivilegeDefineManage.do">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_style">
    ...
    <tr>
      ...
      <td><input type="text" name="privilegeDesc" id="privilegeDesc" size="80" maxlength="500" value="<%=bean.getPrivilegeDesc() %>"/></td>
    </tr>
    <%} %>
  </table>
</form>
...
<li class="page_left_btn">
  <%if(adminHelper.hasPermission(AdminResource.ADMIN_PRIVILEGE_DEFINE, OperationConfig.UPDATE)){ %><input type="button" name="button" id="button" value="提交" onclick="javascript:formData.submit();"><%} %>
</li>
</ul>
</body>
</html>